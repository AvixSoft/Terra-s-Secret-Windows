@echo off
mode con cols=100 lines=62
setlocal enabledelayedexpansion
color 0e
title Terra's Secret
...
echo บ 1) Wander Ismaldora         บ
echo.บ                             บ
echo บ 2) Weapon Shop              บ
echo.บ                             บ
echo บ 3) Armor Shop               บ
echo.บ                             บ
echo บ 4) Heroes Store             บ
echo.บ                             บ
echo บ 5) Trading Post of Cala     บ
echo.บ                             บ
echo บ 6) Heralder's Shop          บ
echo.บ                             บ
echo บ 7) Smuggler                 บ
echo.บ                             บ
echo บ 8) The Dungeons             บ
echo.บ                             บ
echo บ 9) Skill Plot               บ
echo.บ                             บ
echo บ 10) Imaldora Bank           บ
echo.บ                             บ
...
echo          \_____                   \_______
echo               /                          /
echo              /    I S M A L D O R A     /
echo              \                         /
echo         _____/              D   Truffmol       
echo        /                           @    \
echo       /        D     __________         /
echo      /               \         \       /
echo      \Cala           /         /      /
echo       \@ X   _______/          \D ___/
echo        \____/                   \/
echo --------------------------------------------------
echo     X - You     @ - City     D - Dungeon
echo.
echo.
echo.
